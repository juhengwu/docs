...
| Feature | Description |
| --- | --- |
| **Dataset Marketplace** | Browse and add public/community datasets with Pro tier support |
| **Workspace Datasets** | Upload JSON/CSV datasets via drag-and-drop with input, golden answer, and knowledge fields |
| **Attack datasets** | 7 attack categories and 15+ attack methods (GCG, ABJ, PAIR, DAN, CIPHER, etc.) |
| **Dataset types** | Default, A/B Test, and GroundTruth datasets |
| **Random sampling** | Configure prompt count for evaluation runs |

## Evaluations

| Feature | Description |
| --- | --- |
| **Compose Evaluation** | Select datasets, configure prompt count, and launch evaluation runs |
...
| **Website evaluation** | Browser automation with Brave, VNC live viewer, and screenshot capture |
...
| **Screenshot library** | Browse screenshots from browser-use evaluations |
...
<CardGroup cols={2}>
  <Card title="Evaluation deep dive" href="/evaluation">
    Learn more about LLM-as-Judge and security testing.
  </Card>
